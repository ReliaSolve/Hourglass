...
// This program is meant to be run against the Null implementation to verify that
// the callback-based and get-based approaches to log messages work, and to verify
